	...
	lessonsCategory.forEach(item => {
		item.addEventListener("click", e => {
			...
			content.forEach(price => {
				if ((e.target.dataset.category == 'individual' || e.target.dataset.category == 'children') && price.id == 1) {
					price.innerHTML = 339 + ' грн'
				}
				if ((e.target.dataset.category == 'individual' || e.target.dataset.category == 'children') && price.id == 4) {
					price.innerHTML = 1299 + ' грн'
				}
				if ((e.target.dataset.category == 'individual'|| e.target.dataset.category == 'children') && price.id == 8) {
